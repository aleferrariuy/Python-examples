...
import time
# ----- IMPORTANTE!!! -------
# Este número "apunta" a la cámara de nuestra PC.
# si el 0 no funciona, ir probando de uno en uno hasta que alguno funcione.
miCamara = 0
# ---------------------------
# Inicializar el modelo de detección de manos
# A diferencia de nuestro modelo del OCR, éste ya está entrenado!
...
def detectarDedo():   
    if results.multi_hand_landmarks is not None:
        ...
        # el dedo está cerrado
           ...
           pass
# Inicializar la cámara en el índice
